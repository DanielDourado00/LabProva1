...
public interface CardapioRepositoy extends JpaRepository<Cardapio, Integer>{
    List<Cardapio> findCardapioByNome(String idRestaurante);       //Cardapio é a classe que representa o cardápio do restaurante ela é a entidade que será manipulada no banco de dados.
